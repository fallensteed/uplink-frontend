...
import { Comment, CommentPopulated } from "./comment.api";
...
export const mockComment1Populated: CommentPopulated = {
    _id: "636d670dad533cc91bb299b6",
    text: "This is the first comment.",
    post: mockPost1._id,
    user: mockUser1,
...
export const mockComment2Populated: CommentPopulated = {
    _id: "636d67e2c547b909546ff6eb",
    text: "This is the second comment.",
    post: mockPost1._id,
    user: mockUser1,
